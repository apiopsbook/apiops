...
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(value = "a unique identifier for this particular occurrence of the problem")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "a short, human-readable summary of the problem that SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "a human-readable explanation specific to this occurrence of the problem. Like title, this field’s value can be localized")
