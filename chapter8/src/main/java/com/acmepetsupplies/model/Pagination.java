...
@Schema(name = "Pagination", description = "An object containing pagination   information")
...
public class Pagination {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link Pagination#Pagination(URI)}
   */
  @Deprecated
  public Pagination() {
    super();
   ...
   */
  public Pagination(URI self) {
    this.self = self;
  }

  public Pagination self(URI self) {
    this.self = self;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, pagination.self) &&
