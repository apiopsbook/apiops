...
@Validated
@Tag(name = "Reviews", description = "A review is a critical assessment of a product by a customer.")
public interface ReviewsApi {
    ...
    /**
     * GET /v1/catalog/products/{id}/reviews : List reviews
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/vnd.api+json", schema = @Schema(implementation = ReviewsResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/v1/catalog/products/{id}/reviews",
        produces = { "application/vnd.api+json" }
    )
    default ResponseEntity<ReviewsResponse> listProductReviews(
